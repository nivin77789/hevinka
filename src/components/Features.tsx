      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-400 max-w-2xl mx-auto">
            At Hevinka, we deliver cutting-edge software and web solutions that help businesses streamline processes, scale faster, and stay ahead of the competition.
          </p>
        </div>
